...
size = 2
fn_haar = '/home/system8/ros_ws/src/face_rec/scripts/haarcascade_frontalface_default.xml'
fn_dir = '/home/system8/ros_ws/src/face_rec/scripts/att_faces'
detection_height = 60  
...
if __name__ == '__main__':
	try:
		...
		pub_dxl=rospy.Publisher('/tilt_controller/command', Float64, queue_size=10)
			...
			if(num_of_faces>0):
				...
				if(frame_count>frame_count_thres):
					...
					if (h>detection_height):
						...
						print(x,y)
						#delta=(float(x-250)*0.00163)+delta
						#print (delta)
						if(x<100):
							delta=delta-0.20
							pub_dxl.publish(delta)
						elif(x>350):
							delta=delta+0.18
							pub_dxl.publish(delta)
						"""						
